...
### Per iniziare scrivi in modo semplice
Quando si inizia a progettare i prompt, bisogna tenere presente che si tratta di un processo iterativo che richiede molta sperimentazione per ottenere risultati ottimali. L'utilizzo di una semplice strumento come chatgptitalia è un buon punto di partenza.
